  ...
  <div class="section clearfix">
    ...
    <div>
      <div class="form-group clearfix">
        ...
        <div class="col-md-9">
          <input type="text" value="" id="host" name="host" class="form-control" disabled placeholder="Informação já vinda do ambiente" />
        </div>
      </div>
      <div class="form-group clearfix">
        <label for="dbuser" class=" col-md-3">Usuário</label>
        <div class=" col-md-9">
          <input type="text" value="" id="dbuser" name="dbuser" class="form-control" disabled autocomplete="off" disabled placeholder="Informação já vinda do ambiente" />
        </div>
      </div>
      <div class="form-group clearfix">
        <label for="dbpassword" class=" col-md-3">Senha</label>
        <div class=" col-md-9">
          <input type="password" value="" id="dbpassword" name="dbpassword" class="form-control" disabled autocomplete="off" placeholder="Informação já vinda do ambiente" />
        </div>
      </div>
      <div class="form-group clearfix">
        <label for="dbname" class=" col-md-3">Banco de Dados</label>
        <div class=" col-md-9">
          <input type="text" value="" id="dbname" name="dbname" class="form-control" disabled placeholder="Informação já vinda do ambiente" />
        </div>
      </div>
    </div>
  </div>
